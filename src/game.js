...
const rules = [
    ...
    { short: "Palavra proibida", long: "Quem tirar a carta escolhe uma palavra que não pode ser dita. Quem falar bebe." },
    ...
    { short: "Invente sua regra", long: "Regra. Escolhe-se uma regra para o jogo. Ex.: Quem mexer no cabelo bebe. Quem tirou a carta decide se a regra anterior continua junto com a nova" },
